...
class Product(Base):
    ...
    temp_profile: Mapped[str] = mapped_column(String(20), default="中温")
...
class Oven(Base):
    ...
    preheat_min: Mapped[int] = mapped_column(Integer, default=15)
...
class Batch(Base):
    ...
    preheat_min: Mapped[int] = mapped_column(Integer, default=0)  # scheduled profile-change preheat
